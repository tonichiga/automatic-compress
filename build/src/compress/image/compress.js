...
var CompressImage = /** @class */ (function () {
    ...
    CompressImage.prototype.getFiles = function (callback) {
        ...
        fs.readdir(this.input, function (err, files) {
            ...
            var jpgFiles = files.filter(function (file) {
                return _this.defineSuppertedFileExtensions().includes(path.extname(file).toLowerCase());
            });
    ...
    CompressImage.prototype.compressImage = function (inputPath, outputPath, callback) {
        ...
        var command = (0, commands_1.imageCommands)(inputPath, outputPath)[fileExtension];
        (0, child_process_1.exec)(command, function (error, stdout, stderr) {
            if (error) {
                console.error("\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0441\u0436\u0430\u0442\u0438\u0438 \u0438\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F: ".concat(error.message));
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve) {
                                return _this.compressImage(inputPath, outputPath, function (err) {
    ...
    CompressImage.prototype.compressAllJpgImages = function () {
        this.clearDir();
    ...
    CompressImage.prototype.defineSuppertedFileExtensions = function () {
        var commands = (0, commands_1.imageCommands)(this.input, this.output);
